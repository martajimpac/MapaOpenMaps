...
public abstract class Hilt_MapaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MapaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapaFragment_GeneratedInjector) this.generatedComponent()).injectMapaFragment(UnsafeCasts.<MapaFragment>unsafeCast(this));
    }
  }
